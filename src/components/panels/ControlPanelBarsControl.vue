...
<template>
    <div>
        ...
        <v-row no-gutters class="mt-2">
            <v-col class="text-center">
                <v-btn-toggle dense no-gutters class="row no-gutters" style="flex-wrap: nowrap; width: 100%;" >
                    <v-btn @click="doSendMove('X-'+steps, feedrateXY)" color="accent" class="btnMinWidthAuto col" v-for="steps of stepsXYsorted" v-bind:key="'x-'+steps"><span class="body-2">–{{ steps }}</span></v-btn>
                    ...
                    <v-btn @click="doSendMove('X+'+steps, feedrateXY)" color="accent" class="btnMinWidthAuto col" v-for="steps of stepsXYsortedReverse" v-bind:key="'x+'+steps"><span class="body-2">+{{ steps }}</span></v-btn>
                </v-btn-toggle>
            </v-col>
        </v-row>
        <v-row no-gutters class="mt-3">
            <v-col class="text-center">
                <v-btn-toggle dense no-gutters class="row no-gutters" style="flex-wrap: nowrap; width: 100%;" >
                    <v-btn @click="doSendMove('Y-'+steps, feedrateXY)" color="accent" class="btnMinWidthAuto col" v-for="steps of stepsXYsorted" v-bind:key="'y-'+steps"><span class="body-2">–{{ steps }}</span></v-btn>
                    ...
                    <v-btn @click="doSendMove('Y+'+steps, feedrateXY)" color="accent" class="btnMinWidthAuto col" v-for="steps of stepsXYsortedReverse" v-bind:key="'y+'+steps"><span class="body-2">+{{ steps }}</span></v-btn>
                </v-btn-toggle>
            </v-col>
        </v-row>
        <v-row no-gutters class="mt-3">
            <v-col class="text-center">
                <v-btn-toggle dense no-gutters class="row no-gutters" style="flex-wrap: nowrap; width: 100%;" >
                    <v-btn @click="doSendMove('Z-'+steps, feedrateZ)" color="accent" class="btnMinWidthAuto col" v-for="steps of stepsZsorted" v-bind:key="'z-'+steps"><span class="body-2">–{{ steps }}</span></v-btn>
                    ...
                    <v-btn @click="doSendMove('Z+'+steps, feedrateZ)" color="accent" class="btnMinWidthAuto col" v-for="steps of stepsZsortedReverse" v-bind:key="'z+'+steps"><span class="body-2">+{{ steps }}</span></v-btn>
                </v-btn-toggle>
            </v-col>
        </v-row>
    </div>
